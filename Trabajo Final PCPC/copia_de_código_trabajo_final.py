# -*- coding: utf-8 -*-
"""Copia de Código Trabajo Final

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Y4hKEEYztmkBLgLNPzaVAd8OV9Kvw1eE
"""

# To install Plotly for deployment environments like Streamlit, add 'plotly' to a 'requirements.txt' file.
# The `!pip install` command is specific to Colab/Jupyter notebooks and should not be used in a Python script.
